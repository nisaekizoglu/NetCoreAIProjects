        ...
        static async Task<string> AnalyzeSentiment(string text)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                var requestBody = new
                {
                    ...
                    messages = new[]
                    {
                        new {role="system",content="You are an AI analyzes sentiment. You categorize text as Positive, Negative or Natural."},
                        new {role="user",content=$"Analyze the sentiment of this text: \"{text}\" and return only Positive, Negative or Natural"}
                    }
                };
