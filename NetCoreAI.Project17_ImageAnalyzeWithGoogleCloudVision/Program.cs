...
class Program
{
    ...
    private static readonly string imagePath = @"C:\Users\NİSA\OneDrive\Resimler\beautiful-fantasy-wallpaper-ultra-hd-wallpaper-4k-sr10012418-hd.jpg";
    ...
    static async Task Main()
    {
        ...
        Console.WriteLine("------Tespit Edilen Nesne------\n");
