...
class Program
{
    ...
    {
        Console.Write("Hikaye Türünü Seçiniz (Macere, Korku, Bilim Kurgu, Fantastik, Komedi): )");
        ...
        string propmt = $"{genre} türünde bir hikaye yaz. Baş karakterin adı {character}. Hikaye {setting} bölgesinde geiyor. {length} bir hikaye olsun. Giriş, gelişme, sonuç içermeli.";
